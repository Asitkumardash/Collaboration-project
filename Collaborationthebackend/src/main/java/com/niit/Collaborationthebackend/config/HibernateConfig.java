...
public class HibernateConfig {
	...
	// change the following based on your DBMS choice 
		...
		private final static String DATABASE_USERNAME = "asit";
		private final static String DATABASE_PASSWORD = "asit123";
		...
		public SessionFactory getSessionFactory(DataSource dataSource) {
			...
			builder.scanPackages("com.niit.Collaborationthebackend");
